...
namespace Wienerberger.WebService.API.Controllers.V1
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> GetProductRecommendations([FromBody] GetProductRequest getProductsRequest)
        {
            ...
            string recievedImageUrl = @"D:\\Users\\Alen\\Desktop\\AIR2025-feature-AIR2025-3-Create-Web-service-final\\WebService\\ImageComparisonPythonService\\userImage.jpg";
            convertedImage.Save(recievedImageUrl, ImageFormat.Png);

            ProcessStartInfo start = new ProcessStartInfo();
            start.FileName = @"C:\Users\Alen\AppData\Local\Programs\Python\Python37\python.exe";//cmd is full path to python.exe
            start.Arguments = @$"D:\Users\Alen\Desktop\AIR2025-feature-AIR2025-3-Create-Web-service-final\WebService\ImageComparisonPythonService\compareImages.py {recievedImageUrl}";//args is path to .py file and any cmd line args
