using Wienerberger.WebService.API.Common.Attributes;
using Wienerberger.WebService.API.Common.Middlewares;
using Wienerberger.WebService.API.Common.Settings;
using Wienerberger.WebService.API.Swagger;
using Wienerberger.WebService.IoC.Configuration.DI;
...
namespace Wienerberger.WebService.API
{
